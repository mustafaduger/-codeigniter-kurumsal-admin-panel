    ...
    <div class="panel panel-inverse">
     ...
     <div class="panel-wrapper collapse in" aria-expanded="true">
      <div class="panel-body">
        <form action="<?php echo base_url('slider/Add') ?>" enctype= "multipart/form-data" method="post">
          <div class="form-body">
                ...
                <div class="panel-wrapper collapse in">
                  <div class="panel-body">
                    ...
                    <div class="row">
                      ...
                      <input id="slider_order" type="text" value="1" name="slider_order" data-bts-button-down-class="btn btn-default btn-outline" data-bts-button-up-class="btn btn-default btn-outline">
                       </div>
                     </div>
                     <div class="col-md-6">
                       <div class="form-group">
