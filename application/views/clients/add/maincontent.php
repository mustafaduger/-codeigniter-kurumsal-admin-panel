    ...
    <div class="panel panel-inverse">
     ...
     <div class="panel-wrapper collapse in" aria-expanded="true">
      <div class="panel-body">
        <form action="<?php echo base_url('clients/Add') ?>" enctype= "multipart/form-data" method="post">
          <div class="form-body">
                ...
                <div class="panel-wrapper collapse in">
                  <div class="panel-body">
                     ...
                     <div class="row">
                      <div class="col-md-12 ">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="clients_url" value ="">
                    ...
                    <div class="row">
                      ...
                      <input id="clients_order" type="text" value="1" name="clients_order" data-bts-button-down-class="btn btn-default btn-outline" data-bts-button-up-class="btn btn-default btn-outline">
                       </div>
                     </div>
                     <div class="col-md-6">
                       <div class="form-group">
